...
<div class="content-wrapper" style="background:#f8f9fa">
    <div class="navbar navbar-light bg-light titulo-pagina">
        <h1 class="navbar-brand" style="margin-top: 5px;">Adicionar produto</h1>
    </div>
            ...
            <form method="post" action="add.php">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label>Nome</label>
                        <input type="text" class="form-control" id="nome" name="nome" placeholder="" autocomplete="off" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label>Apelido</label>
                        <input id="apelido" name="apelido" class="form-control" placeholder="" autocomplete="off" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>Valor</label>
                        <input type="text" class="form-control" id="valor" name="valor" placeholder="1,99" autocomplete="off" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Codigo de barras</label>
                        <input type="text" class="form-control" id="cod_barras" name="cod_barras" placeholder="789654654654" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="qtd" name="qtd" placeholder="99" autocomplete="off" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Quantidade minima</label>
                        <input type="text" class="form-control" id="qtd_min" name="qtd_min" placeholder="0" autocomplete="off"required>
                    </div>
                </div>
