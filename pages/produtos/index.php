...
<div class="content-wrapper" style="background:#f8f9fa">
    ...
    <div class="container-fluid mt-3">
        <div class="col-sm-12">
            ...
            <div class="row">
                <a class="btn btn-success m-3" href="adicionar.php"><i class="fa fa-plus"></i> Adicionar Produto</a>
            </div>
            ...
            <table class="table table-hover table-striped">
                ...
                if (!empty($produtos)) {
                    foreach ($produtos as $produto) {
                        ...
                        echo '<td width="20%">
                        <a class="btn btn-sm btn-primary text-center margin1" href="">
                            <span data-toggle="tooltip" title="Detalhes"> &nbsp;<i class="fa fa-info"> </i>&nbsp;</span>
                        </a>

                        <a class="btn btn-sm btn-success text-center margin1" href="">
